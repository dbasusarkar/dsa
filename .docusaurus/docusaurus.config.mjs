...
export default {
  ...
  "plugins": [
    ...
    "/Users/Debajyoti/Wölkli-PRO/My Cloud Stuff/Computing/My GitHub Stuff/intro-to-dsa/dsabydbasusarkar/node_modules/@cmfcmf/docusaurus-search-local/lib/server/index.js"
  ],
  "themeConfig": {
    "prism": {
      "theme": {
